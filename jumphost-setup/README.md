...
```commandline
ansible-playbook plays/pb_server_setup.yml -i hosts/hosts.ini -Kk -vvvv
ansible-playbook plays/pb_server_setup.yml -i hosts/hosts.ini -Kk -vvvv --tags "python31014"
```
